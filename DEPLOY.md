...
10. [Автозапуск при перезагрузке сервера](#10-автозапуск-при-перезагрузке-сервера)
11. [Настройка Nginx (reverse proxy + HTTPS)](#11-настройка-nginx-reverse-proxy--https)
12. [Подключение виджета к сайту заказчика](#12-подключение-виджета-к-сайту-заказчика)
...
## 11. Настройка Nginx (reverse proxy + HTTPS)
...
## 12. Подключение виджета к сайту заказчика
