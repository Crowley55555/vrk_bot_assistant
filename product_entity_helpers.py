...
_CATEGORY_STOP: frozenset[str] = frozenset({
    ...
    "что", "такое", "какой", "какая", "какие", "про", "для", "под", "наш", "наша",
    "экран", "экраны", "панель", "панели",
    "потолочный", "потолочные", "потолок", "потолка", "теневой", "теневые", "скрытый", "скрытая",
    "скрытого", "монтажа", "натяжной", "натяжного", "натяжный", "гипсокартон", "гипсокартона",
    "шпаклевка", "шпаклевку", "шпаклевкой", "дизайнерский", "шумоподавляющий",
    "перфорированный", "универсальный", "вихревой", "сопловый", "струйный",
    "веерный", "конический", "напольный", "приточный", "вытяжной",
    "приточно-вытяжной", "круглый", "круглая", "квадратный", "квадратная", "мм",
})
